    ...
    <>
      ...
      <div className="h-full w-full bg-slate-100">
        ...
        >
          ...
          <div>
            {loading ? (
              <div className="skeleton h-11 md:w-[30%] w-[60%] mt-5 m-auto rounded-3xl"></div>
            ) : (
              <h1
                className={`${
                  loading ? "hidden" : "block"
                } text-base md:text-xl mt-5 text-center bg-[#422AFB] py-2 text-white rounded-3xl m-auto w-[60%] md:w-[30%]`}
              >
                Sản phẩm bán chạy
              </h1>
            )}
          ...
          <div className="min-h-[930px]">
            {loading ? (
              ...
              <h1
                className={`${
                  loading ? "hidden" : "block"
                } text-lg md:text-xl  mt-5 text-center bg-[#422AFB] py-2 text-white rounded-3xl m-auto w-[60%] md:w-[30%]`}
              >
                Tất cả sản phẩm
              </h1>
            )}
